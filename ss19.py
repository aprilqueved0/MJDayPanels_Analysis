...
data = {
    ...
    "2025": {
        "spring": {
            "time_slot": ["9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "12:00 p.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "3:00 p.m."],
            "student": ["Mikayla Roberts", "Taylor Nichols", "April Quevedo", "Keelin Brown", "Loretta Pulwer", "Adriana Navarro", "Mekhi Abbott", "Daranee Balachandar", "Robert Stewart", "Aidan Hughes", "Alexa Henry", "Caitlin Kelley", "Menna Ibrahim", "Halexys Williams", "Paul Kiefer"],
            "panelists": ["Adam Marton", "Alanna Delfino Kopania", "David Lightman," "Rick Martin (alum)", "Derek Willis", "Kathy Best", "Sean Mussenden", "Adam Marton", "Rachel Marconi (alum)", "Adam Marton", "Derek Willis", "Kathy Best", "Chris Harvey", "Greg Morton (alum)", "Nathan Stevens", "Josh Davidsburg", "Alanna Kopania", "Eugene Obah (alum)", "Alanna Kopania", "Josh Davisburg", "Keir Johnson (alum)", "Sean Mussenden", "Ryan Little", "Christi Parsons", "Sapna Bansil (alum)", "Mark Hyman", "Kevin Blackistone", "Stacey Decker", "Megan Sayles (alum)", "Chris Harvey", "Kathy Best", "Adam Marton", "Sapna Bansil (alum)", "Christi Parsons", "Christoph Mergerson", "Derek Willis", "Brenda Wintrode (alum)", "Rob Wells", "Kathy Best", "Derek Willis", "Ryan Little (alum)", "Mel Coffee", "Kevin Blackistone", "Joe Yasharoff", "Monica McNutt (alum)", "Tom Rosenstiel", "Bob Little", "Stev Drummond", "Julie Depenbrock (alum)", "Jim Carroll", "DeNeen Brown", "Dana Priest", "Nathan Stevens", "Jamal Francis (alum)", "Christi Parsons", "Sean Mussenden"]
        }
    }
}
