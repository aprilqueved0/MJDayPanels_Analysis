...
data = {
    "2019": {
        "spring": {
            "time_slot": ["10:00 a.m.", "10:00 a.m."],
            "student": ["Lindsay Huth", "Brooks DuBose"],
            "panelists": [
        ...
        "fall": {
            "time_slot": ["10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "1:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "student": ["Emily Top", "Hannah Gaskill", "Horus Alas", "Lauren Moses", "Nora Eckert", "Colleen Crowley", "Elliott Davis", "Ian Round", "Roxanne Ready", "William Pitts"],
    ...
    "2020": {
        "spring": {
            "time_slot": ["10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m."],
            "student": ["amal Williams", "Camila Velloso", "Mike Revollo", "Elena Macias", "Amina Ndiaye", "Theresa Diffendal", "Dan Novak", "Riin Aljas", "Samantha Hawkins"],
        ...
        "fall": {
            "time_slot": ["1:00 p.m.", "9:00 a.m.", "8:00 a.m.", "11:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "12:00 p.m."],
            "student": ["Kelsey Mannix", "Maya Pottiger", "Bryan Gallion", "Jaime Williams", "Julia Lerner", "Jacob Rousseau", "Mohan Xu", "Renee Foose", "Sean McGoey", "Brenda Wintrode", "Ya-Marie Sesay", "Ryan Little", "India Afriyie"],
    ...
    "2021": {
        "spring": {
            "time_slot": ["9:00 a.m.", "10:00 a.m.", "9:00 a.m.", "10:00 a.m.","10:00 a.m.", "11:00 a.m.", "10:00 a.m.", "11:00 a.m.", "1:00 p.m.", "9:00 a.m.", "11:00 a.m.", "3:30 p.m.", "1:00 p.m.", "10:00 a.m.", "10:00 a.m.", "1:00 p.m.", "2:00 p.m."],
            "student": ["Sydney Clark", "Luciana Perez Uribe", "Philip Van Slooten", "Grace Todd", "Ryan McFadden", "Madison Hunt", "Rayonna Burton-Jernigan", "Kimberly Escobar", "Darryl Kinsey", "Aneurin Canham Clyne", "Laina Miller", "Tayler Adigun", "Callan Tansill-Suddath", "Simone Ebongo-Bayehe", "Victoria Daniels", "Adebowale (Jummy) Owookade", "Michelle Siegel"],
        ...
        "fall": {
            "time_slot": ["1:00 p.m.", "9:00 a.m.", "8:00 a.m.", "11:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "12:00 p.m."],
            "student": ["Julia Arbutus", "Natalie Hays Drum", "Brittany Gaddy", "Kelly Livingston", "Allison Mollenkamp", "Glory Ngwe", "Gabriel Pietrorazio", "Nicholas McMillan"],
    ...
    "2022": {
        "spring": {
            "time_slot": ["9:00 a.m.", "9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "2:00 p.m.", "9:00 a.m.", "10:00 a.m."],
            "student": ["Rachel Logan", "Jon White", "Ashkan Motamedi", "Molly Work", "Chris Barylick", "Collin Riviello", "Kara Newhouse", "Vanessa Sanchez", "Trisha Ahmed Hoque", "Aadit Tambe", "Katie Benzan"],
        ...
        "fall": {
            "time_slot": ["9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "12:00 p.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m.", "3:00 p.m.", "9:30 a.m."],
            "student": ["Deanna Giles", "Emmett Gartner", "Markayla Brooks", "Shannon Clark", "Nicholas Doyle", "Abby Zimmardi", "Valeria Gonzalez", "Tatyana Monnay", "Tim Dashiell", "Kate Seltzer", "Lyna Bentahar", "Ekaterina Pechenkina", "John Little", "Eve Sampson", "Jon Donville"],
    ...
    "2023": {
        "spring": {
            "time_slot": ["8:00 a.m.", "9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "student": ["Stephen Neukam", "Michael Charles", "Jon Meltzer", "John Ndiso", "Hunter Savery", "Destiny Herbers", "Mythili Devarakonda", "Ian Decker", "Marianeli DeLeon", "Victoria Ifatusin", "Tinashe Chingarange"],
        ...
        "fall": {
            "time_slot": ["9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m.", "4:00 p.m.", "9:00 a.m."],
            "student": ["Jessica Schwartz", "Jamille Whitlow", "Carl McManus", "Avery Newport", "Abbi Ross", "Mike Levitsky", "Ethan Cannistra", "Abby Wallace", "Sarah Siock", "Ryan Mercado", "Dylan Manfre", "Greg Morton"],
    ...
    "2024": {
        "spring": {
            "time_slot": ["10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "student": ["Lisa Woelfl", "Sununu Bah", "Caroline Koutsos", "Torrence Banks", "Mathew Schumer", "Fatema Hosseini", "Sapna Bansil", "Steph Quinn"],
        ...
        "fall": {
            "time_slot": ["9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m."],
            "student": ["Caley Fox Shannon", "Steven Jacobs", "Imani Agbionu", "Leila Cox", "Alisha Camacho", "Dylan Shulman", "Shaun Chornobroff", "Shaela Foster", "Andrea Duran"],
    ...
    "2025": {
        "spring": {
            "time_slot": ["9:00 a.m.", "9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "12:00 p.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "3:00 p.m."],
            "student": ["Mikayla Roberts", "Taylor Nichols", "Halexys Williams", "April Quevedo", "Keelin Brown", "Paul Kiefer", "Menna Ibrahim", "Adriana Navarro", "Loretta Pulwer", "Mekhi Abbott", "Daranee Balachandar", "Robert Stewart", "Aidan Hughes", "Alexa Henry", "Caitlin Kelley"],
            "panelists": ["Adam Marton", "Alanna Kopania", "David Lightman", "Rick Martin (alum)", "Derek Willis", "Kathy Best", "Sean Mussenden", "Adam Marton", "Rachel Marconi (alum)", "Nathan Stevens", "Christoph Mergerson", "Mel Coffee", "Jamal Francis (alum)", "Adam Marton", "Derek Willis", "Kathy Best", "Chris Harvey", "Greg Morton (alum)", "Nathan Stevens", "Josh Davidsburg", "Alanna Kopania", "Eugene Obah (alum)", "Christi Parsons", "Sean Mussenden", "Deb Nelson", "Sapna Bansil (alum)", "Jim Carroll", "DeNeen Brown", "Dana Priest", "Joy Saha (alum)", "Sean Mussenden", "Ryan Little", "Christi Parsons", "Sapna Bansil (alum)", "Alanna Kopania", "Josh Davidsburg", "Alison Burns", "Keir Johnson (alum)", "Mark Hyman", "Kevin Blackistone", "Stacey Decker", "Megan Sayles (alum)", "Chris Harvey", "Kathy Best", "Adam Marton", "Sapna Bansil (alum)", "Christi Parsons", "Christoph Mergerson", "Derek Willis", "Brenda Wintrode (alum)", "Rob Wells", "Kathy Best", "Derek Willis", "Ryan Little (alum)", "Mel Coffee", "Kevin Blackistone", "Joe Yasharoff", "Monica McNutt (alum)", "Tom Rosenstiel", "Bob Little", "Steve Drummond", "Julie Depenbrock (alum)"]
        }
    }
}
