...
data = {
    "2019": {
        "spring": {
            "time slot": ["10:00 a.m.", "10:00 a.m."],
            "students": ["Lindsay Huth", "Brooks DuBose"],
            "panelists": [
        ...
        "fall": {
            "time slot": ["10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "1:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "students": ["Emily Top", "Hannah Gaskill", "Horus Alas", "Lauren Moses", "Nora Eckert", "Colleen Crowley", "Elliott Davis", "Ian Round", "Roxanne Ready", "William Pitts"],
    ...
    "2020": {
        "spring": {
            "time slot": ["10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m."],
            "students": ["amal Williams", "Camila Velloso", "Mike Revollo", "Elena Macias", "Amina Ndiaye", "Theresa Diffendal", "Dan Novak", "Riin Aljas", "Samantha Hawkins"],
        ...
        "fall": {
            "time slot": ["1:00 p.m.", "9:00 a.m.", "8:00 a.m.", "11:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "12:00 p.m."],
            "students": ["Kelsey Mannix", "Maya Pottiger", "Bryan Gallion", "Jaime Williams", "Julia Lerner", "Jacob Rousseau", "Mohan Xu", "Renee Foose", "Sean McGoey", "Brenda Wintrode", "Ya-Marie Sesay", "Ryan Little", "India Afriyie"],
    ...
    "2021": {
        ...
        "fall": {
            "time slot": ["1:00 p.m.", "9:00 a.m.", "8:00 a.m.", "11:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "12:00 p.m."],
            "students": ["Julia Arbutus", "Natalie Hays Drum", "Brittany Gaddy", "Kelly Livingston", "Allison Mollenkamp", "Glory Ngwe", "Gabriel Pietrorazio", "Nicholas McMillan"],
    ...
    "2022": {
        "spring": {
            "time slot": ["9:00 a.m.", "9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "2:00 p.m.", "9:00 a.m.", "10:00 a.m."],
            "students": ["Rachel Logan", "Jon White", "Ashkan Motamedi", "Molly Work", "Chris Barylick", "Collin Riviello", "Kara Newhouse", "Vanessa Sanchez", "Trisha Ahmed Hoque", "Aadit Tambe", "Katie Benzan"],
        ...
        "fall": {
            "time slot": ["9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "12:00 p.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m.", "3:00 p.m.", "9:30 a.m."],
            "students": ["Deanna Giles", "Emmett Gartner", "Markayla Brooks", "Shannon Clark", "Nicholas Doyle", "Abby Zimmardi", "Valeria Gonzalez", "Tatyana Monnay", "Tim Dashiell", "Kate Seltzer", "Lyna Bentahar", "Ekaterina Pechenkina", "John Little", "Eve Sampson", "Jon Donville"],
    ...
    "2023": {
        "spring": {
            "time slot": ["8:00 a.m.", "9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "students": ["Stephen Neukam", "Michael Charles", "Jon Meltzer", "John Ndiso", "Hunter Savery", "Destiny Herbers", "Mythili Devarakonda", "Ian Decker", "Marianeli DeLeon", "Victoria Ifatusin", "Tinashe Chingarange"],
        ...
        "fall": {
            "time slot": ["9:00 a.m.", "9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m.", "4:00 p.m.", "9:00 a.m."],
            "students": ["Jessica Schwartz", "Jamille Whitlow", "Carl McManus", "Avery Newport", "Abbi Ross", "Mike Levitsky", "Ethan Cannistra", "Abby Wallace", "Sarah Siock", "Ryan Mercado", "Dylan Manfre", "Greg Morton"],
    ...
    "2024": {
        "spring": {
            "time slot": ["10:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "2:00 p.m.", "3:00 p.m."],
            "students": ["Lisa Woelfl", "Sununu Bah", "Caroline Koutsos", "Torrence Banks", "Mathew Schumer", "Fatema Hosseini", "Sapna Bansil", "Steph Quinn"],
        ...
        "fall": {
            "time slot": ["9:00 a.m.", "10:00 a.m.", "11:00 a.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "1:00 p.m.", "2:00 p.m.", "2:00 p.m."],
            "students": ["Caley Fox Shannon", "Steven Jacobs", "Imani Agbionu", "Leila Cox", "Alisha Camacho", "Dylan Shulman", "Shaun Chornobroff", "Shaela Foster", "Andrea Duran"],
    ...
    "2025": {
        "spring": {
            "time slot": ["9:00 a.m.", "10:00 a.m.", "10:00 a.m.", "11:00 a.m.", "11:00 a.m.", "11:00 a.m.", "12:00 p.m.", "12:00 p.m.", "12:00 p.m.", "1:00 p.m.", "1:00 p.m.", "3:00 p.m."],
            "students": ["Taylor Nichols", "April Quevedo", "Keelin Brown", "Mikayla Roberts", "Loretta Pulwer", "Adriana Navarro", "Mekhi Abbott", "Daranee Balachandar", "Robert Stewart", "Aidan Hughes", "Alexa Henry", "Caitlin Kelley", "Halexys Williams", "Paul Kiefer"],
